\documentclass[num-refs]{wiley-article}%%%%where rsproca is the template name
...
\begin{figure}[!h]%[tbhp]
\centering
\includegraphics[width=\linewidth]{Figs/ReplicatePerformance_Polytomy.png}
...
\begin{figure}%[tbhp]
\centering
\includegraphics[width=\linewidth]{Figs/VarImportance_ErrBars_Short.png}
