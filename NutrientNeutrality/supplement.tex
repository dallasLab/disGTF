...
\includegraphics[
  width=20cm]{NutrientNeutrality/Figures/CommunityBarcharts.pdf}
...
\begin{tikzpicture}[remember picture, overlay]
  \node at ([xshift=3.25in,yshift=-5in]current page.east) {\thepage};
  \end{tikzpicture}
